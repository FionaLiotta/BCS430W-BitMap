...
function fillCountryColor() {
  countries.features.forEach(function(c, i) {
    let color =
      countryColors[c.id] && countryColors[c.id].color && countryColors[c.id].totalBits !== 0 
...
function loadData(cb) {
  d3.json("https://raw.githubusercontent.com/KoGor/Map-Icons-Generator/master/data/world-110m.json", function(
    error,
    world
  ) {
